...
namespace Brew.Models
{
    public class Models
    {
        ...
        {
            public static readonly string PELLET = "Pellet";
        ...
        {
            public static readonly string BITTERING = "Bittering";
            public static readonly string AROMA = "Aroma";
        ...
        public class HopUse
        {
            ...
            public static readonly string DRY_HOP = "Dry Hop";
            public static readonly string MASH = "Mash";
            public static readonly string FIRST_WORT = "First Wort";
            public static readonly string AROMA = "Aroma";
        }
        ...
        public class Hop
        {
            ...
            public float AlphaPercentage { get; set; } // Percent alpha of hops - for example "5.5" represents 5.5% alpha
            public float Weight { get; set; } // Weight in Kilograms of the hops used in the recipe.
            public HopUse Use { get; set; }
            public DateTime Time { get; set; } // Meaning is dependent on the “USE” 
        ...
        public class Style
        {
            ...
            public string SyuleLetter { get; set; } // The specific style number or subcategory letter associated with this particular style.  
            public string SyuleGuide { get; set; } // The name of the style guide that this particular style or category belongs to
